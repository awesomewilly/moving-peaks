...
public class Peak_Function_Cone implements Peak_Function {
	...
	public double calculate(double[] gen, int peak_number) {
		...
		return movpeaks.peak[peak_number][movpeaks.geno_size
			+ 1]
			- (movpeaks.peak[peak_number][movpeaks.geno_size] * Math.sqrt(dummy));
