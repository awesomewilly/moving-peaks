...
/**
 * @author Vicente BelinchÛn Gonz·lez
 *
 */
...
public class PSO {
	...
	private static final int PORC_VECINDAD = 20; //Se trata del porcentaje de distancia que debe existir entre dos partículas para poder ser considerada vecina
	 ...
	 * en función de los valores de rCognitivo y rSocial
	 * 
	 * Modelo completo: rCognitivo, rSocial > 0. 
	 * SóloCognitivo:rCognitivo>0 y rSocial=0. 
	 * SóloSocial:rCognitivo=0 y rSocial>0.
	 */
	...
	/*Método encargado de la inicialización de la nube de particulas
	 ...
	 * Vmax será la velocidad máxima que puede tomar una párticula
	 */
	...
	/*Este método será el encargado de devolver la mejor solución 
	...
	/*Este método será el encargado de devolver el mejor óptimo 
	 * para una nube de particulas dada*/
	...
	private Particula psoLocal() {
		...
		/*
		 * Array encargado de asociar cada partícula de la nube, con la mejor partícula de la vecindad
		 */
